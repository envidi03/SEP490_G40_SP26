...
/**
 * ServicePagination - Component phân trang cho danh sách dịch vụ
 * 
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mt-8">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
                ...
                <div className="text-sm text-gray-600">
                    Hiển thị <span className="font-semibold text-gray-900">{startItem}</span> - <span className="font-semibold text-gray-900">{endItem}</span> trong tổng số <span className="font-semibold text-blue-600">{totalItems}</span> dịch vụ
                </div>
